...
func (_m *viperIfMock) GetEnvPrefix() string {
	ret := _m.Called()
...
// viperIfMock_GetEnvPrefix_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetEnvPrefix'
type viperIfMock_GetEnvPrefix_Call struct {
	*mock.Call
}

// GetEnvPrefix is a helper method to define mock.On call
func (_e *viperIfMock_Expecter) GetEnvPrefix() *viperIfMock_GetEnvPrefix_Call {
	return &viperIfMock_GetEnvPrefix_Call{Call: _e.mock.On("GetEnvPrefix")}
}

func (_c *viperIfMock_GetEnvPrefix_Call) Run(run func()) *viperIfMock_GetEnvPrefix_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *viperIfMock_GetEnvPrefix_Call) Return(_a0 string) *viperIfMock_GetEnvPrefix_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *viperIfMock_GetEnvPrefix_Call) RunAndReturn(run func() string) *viperIfMock_GetEnvPrefix_Call {
	_c.Call.Return(run)
	return _c
}
