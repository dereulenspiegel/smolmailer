...
func (_m *GenericWorkQueueMock[T]) Queue(ctx context.Context, item T, options ...queue.QueueOption) error {
...
func (_c *GenericWorkQueueMock_Queue_Call[T]) Run(run func(ctx context.Context, item T, options ...queue.QueueOption)) *GenericWorkQueueMock_Queue_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *GenericWorkQueueMock_Queue_Call[T]) RunAndReturn(run func(context.Context, T, ...queue.QueueOption) error) *GenericWorkQueueMock_Queue_Call[T] {
	_c.Call.Return(run)
	return _c
}
