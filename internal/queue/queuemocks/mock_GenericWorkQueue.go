...
// Consume provides a mock function with given fields: ctx, worker, options
func (_m *GenericWorkQueueMock[T]) Consume(ctx context.Context, worker liteq.ConsumeFunc[T], options ...liteq.ConsumeOpt) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, liteq.ConsumeFunc[T], ...liteq.ConsumeOpt) error); ok {
		r0 = rf(ctx, worker, options...)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - worker liteq.ConsumeFunc[T]
//   - options ...liteq.ConsumeOpt
func (_e *GenericWorkQueueMock_Expecter[T]) Consume(ctx interface{}, worker interface{}, options ...interface{}) *GenericWorkQueueMock_Consume_Call[T] {
	return &GenericWorkQueueMock_Consume_Call[T]{Call: _e.mock.On("Consume",
		append([]interface{}{ctx, worker}, options...)...)}
}

func (_c *GenericWorkQueueMock_Consume_Call[T]) Run(run func(ctx context.Context, worker liteq.ConsumeFunc[T], options ...liteq.ConsumeOpt)) *GenericWorkQueueMock_Consume_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(context.Context), args[1].(liteq.ConsumeFunc[T]), variadicArgs...)
	})
	return _c
}
...
func (_c *GenericWorkQueueMock_Consume_Call[T]) RunAndReturn(run func(context.Context, liteq.ConsumeFunc[T], ...liteq.ConsumeOpt) error) *GenericWorkQueueMock_Consume_Call[T] {
	_c.Call.Return(run)
	return _c
}

// Queue provides a mock function with given fields: ctx, item, options
func (_m *GenericWorkQueueMock[T]) Queue(ctx context.Context, item T, options ...liteq.QueueOption) error {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, T, ...liteq.QueueOption) error); ok {
...
func (_c *GenericWorkQueueMock_Queue_Call[T]) Run(run func(ctx context.Context, item T, options ...liteq.QueueOption)) *GenericWorkQueueMock_Queue_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *GenericWorkQueueMock_Queue_Call[T]) RunAndReturn(run func(context.Context, T, ...liteq.QueueOption) error) *GenericWorkQueueMock_Queue_Call[T] {
	_c.Call.Return(run)
	return _c
}
